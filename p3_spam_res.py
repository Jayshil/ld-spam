...
f101.write('Claret(2017), PHOENIX - r method\t\t' + str(u1_cla_pho_r[0]) + ' +/- ' + str(u1_cla_pho_r[1]) + '\t\t' + str(u2_cla_pho_r[0]) + ' +/- ' + str(u2_cla_pho_r[0]) + '\n')
f101.write('Claret(2017), ATLAS\t\t' + str(u1_cla_ata[0]) + ' +/- ' + str(u1_cla_ata[1]) + '\t\t' + str(u2_cla_ata[0]) + ' +/- ' + str(u2_cla_ata[0]) + '\n')
f101.write('EJ(2015), PHOENIX\t\t' + str(u1_code_pho[0]) + ' +/- ' + str(u1_code_pho[0]) + '\t\t' + str(u2_code_pho[0]) + ' +/- ' + str(u2_code_pho[0]) + '\n')
